...
public class DimmerFan extends BaseRegulator
{
    ...
    public boolean ShowPopup(Context context)
    {
        ...
        final ScrollingDialog.SFSeeker pSeeker = (ScrollingDialog.SFSeeker)ScrollingDialog.AddSeekBar(m_sVariableValue, context.getString(R.string.sdSpeed), m_iValue * 100 / m_iMaxValue, (int) m_fValueMin, (int) m_fValueMax, "%d %%", m_iReaction != 0
