...
public class ClimatConditioner extends BaseClimat
{
    ...
    {
        super(iX, iY, R.drawable.ccond1off, 1, sName, bMetaInd, bProtected, bDoubleScale, bQuick, iReaction, iScale);
        ...
        if(m_bPower)
        {
            switch(m_iMode)
            {
                case 0:
                    ...
                    break;
                case 1:
                    iResId = R.drawable.ccond2on;
                    break;
                case 2:
                    iResId = R.drawable.ccond3on;
                    break;
                case 3:
        ...
        else
        {
            switch(m_iMode)
            {
                case 0:
                    ...
                    break;
                case 1:
                    iResId = R.drawable.ccond2off;
                    break;
                case 2:
                    iResId = R.drawable.ccond3off;
                    break;
                case 3:
