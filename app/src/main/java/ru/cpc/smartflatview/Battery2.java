...
public class Battery2 extends BaseRegulator
{
    ...
    {
        super(iX, iY, R.drawable.radiator_off, 6, sName, bMetaInd, bProtected, bDoubleScale, bQuick, iReaction, iScale);
    ...
    protected boolean Update()
    {
        ...
        {
            iResId = R.drawable.radiator_off;
...
//                iResId = R.drawable.id252;
    ...
    public boolean ShowPopup(Context context)
    {
        ...
        final ScrollingDialog.SFSeeker pSeeker = (ScrollingDialog.SFSeeker)ScrollingDialog.AddSeekBar(m_sVariableValue, "Температура", m_iValue, (int) m_fValueMin, (int) m_fValueMax, "%d °C", m_iReaction != 0
