...
public class MacroPumpAddWater extends BaseMacro
{
	...
	{
		super(iX, iY,
				newDez?R.drawable.st16_2:R.drawable.st16,
				newDez?R.drawable.st16_2:R.drawable.st16, 16, sName, sButtonName, bMetaInd, bProtected, bDoubleScale, bQuick, iReaction, iScale);
